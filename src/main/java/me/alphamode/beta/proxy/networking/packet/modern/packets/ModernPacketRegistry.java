...
import me.alphamode.beta.proxy.networking.packet.modern.packets.c2s.configuration.C2SConfigurationClientInformationPacket;
...
public class ModernPacketRegistry extends PacketRegistry<ModernPackets, ModernPacket<ModernPackets>> {
	...
	private void registerPlayPackets() {
		...
		this.registerPacket(ServerboundPlayPackets.CONTAINER_CLICK, C2SContainerClickPacket.CODEC);
		...
		this.registerPacket(ServerboundPlayPackets.CUSTOM_PAYLOAD, C2SPlayCustomPayloadPacket.CODEC);
		...
		this.registerPacket(ClientboundPlayPackets.CUSTOM_PAYLOAD, S2CPlayCustomPayloadPacket.CODEC);
		...
		this.registerPacket(ClientboundPlayPackets.HURT_ANIMATION, S2CHurtAnimationPacket.CODEC);
		...
		this.registerPacket(ClientboundPlayPackets.SET_ENTITY_MOTION, S2CSetEntityMotionPacket.CODEC);
	...
	private void registerConfigurationPackets() {
		// Serverbound
		this.registerPacket(ServerboundConfigurationPackets.CLIENT_INFORMATION, C2SConfigurationClientInformationPacket.CODEC);
		...
		this.registerPacket(ServerboundConfigurationPackets.KEEP_ALIVE, C2SConfigurationKeepAlivePacket.CODEC);
