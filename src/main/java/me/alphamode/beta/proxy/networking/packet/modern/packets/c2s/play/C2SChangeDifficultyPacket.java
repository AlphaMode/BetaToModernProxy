...
import me.alphamode.beta.proxy.util.data.modern.enums.Difficulty;

public record C2SChangeDifficultyPacket(Difficulty difficulty) implements C2SPlayPacket {
	public static final StreamCodec<ByteStream, C2SChangeDifficultyPacket> CODEC = StreamCodec.composite(
			Difficulty.CODEC,
