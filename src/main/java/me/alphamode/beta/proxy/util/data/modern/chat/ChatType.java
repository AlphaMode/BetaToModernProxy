...
public class ChatType {
	public static final StreamCodec<ByteStream, Holder<ChatType>> CODEC = null; // TODO

	public record Bound(Holder<ChatType> chatType, TextComponent name, Optional<TextComponent> targetName) {
		public static final StreamCodec<ByteStream, Bound> CODEC = StreamCodec.composite(
				ChatType.CODEC,
